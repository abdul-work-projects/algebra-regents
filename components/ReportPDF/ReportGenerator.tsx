  ...
  if (iconOnly) {
    return (
      <button
        ...
        className="p-3 text-gray-600 hover:text-gray-900 bg-gray-100 hover:bg-gray-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl transition-all"
